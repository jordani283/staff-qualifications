...
const CertificationModal = ({ 
  ...
  return (
    ...
    >
      <div 
        ref={modalRef}
        className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-2xl max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-200"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-slate-200">
          <h2 id="modal-title" className="text-xl font-semibold text-slate-900 flex items-center gap-2">
          ...
          <div className="space-y-4 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-2 space-y-4">
                <div className="h-6 flex items-center text-slate-900 font-medium">
                  {certification.certification_name || 'Not specified'}
                </div>
                <div className="h-6 flex items-center text-slate-700">
                ...
                <div className="h-6 flex items-center gap-3">
                  ...
                  {canRenew && onRenew && (certification.status === 'Expiring Soon' || certification.status === 'Expired') && (
                    <button
                      ...
                      className="flex items-center gap-1 px-2.5 py-1 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-medium rounded-full transition-colors"
